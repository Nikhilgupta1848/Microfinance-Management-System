   ...
   <div class="card ">
      ...
      <strong><?php echo isset($_SESSION['success_msg']) ? $_SESSION['success_msg'] : ''; ?></strong>
            ...
            <form action="app/openaccountHandler.php" method="post">
               ...
               $account_number = rand(100000, 800000000);
               ?>
                  ...
                  <div class="form-group">
                     ...
                     <select class="custom-select" name="account_status" id="">
                      <option selected>Select one</option>
                        ...
                        <option value="<?php echo $rows['account_status_number']; ?>">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary" name="open_account">Open Account</button>
                  </div>
